...
const ExpenseInfo = async ({ params }) => {
  ...
  return (
    <div className='flex flex-col w-full h-full'>
      ...
      <div className='flex flex-col justify-center w-full gap-4 p-4 mx-auto border shadow-xl bg-yellow-400/30 lg:w-1/3 h-5/6 rounded-2xl'>
        ...
        <CrudExpense expense_id={expense?.result?.payment_mode_id?._id} />
      </div>
    </div>
  )
}
