...
const NavbarMobile = () => {
 const [mobileNav, setMobileNav] = useState(false);
  return (
    ...
    {mobileNav && <div className={`fixed inset-0 w-full h-full bg-white rounded-2xl shadow-2xl z-20`}>
     <div className='z-20 flex items-center w-full h-auto px-2 py-2 border-b'>
     ...
     <div className='z-20 flex flex-col items-center justify-around bg-white h-5/6'>
